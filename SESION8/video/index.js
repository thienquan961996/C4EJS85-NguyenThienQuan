...
// let count = 0;
// let button1 = document.getElementById('byUp');
// let button2 = document.getElementById('byDown');
// let so = document.getElementById('count');
...
// const start = document.getElementById('timer1');
// const stop_btn = document.getElementById('timer2');
...
// function showData(){
//   randomdata = data[Math.floor(data.length*Math.random())];
//   quote.innerHTML = randomdata.quoteText;
//   author.innerHTML = randomdata.quoteAuthor
// };
// showData();
