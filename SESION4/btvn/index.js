...
// console.log('x trả về là property');
...
//        console.log(x + ":" + " " + product1[x]);
//    }
// }else if ( num == 2){
//     for ( let x in product2){
//         console.log(x + ":" + "" + product2[x]);
//     }
// }else if ( num == 3){
//     for ( let x in product3){
//         console.log(x + ":" + " " + product3[x]);
//     }
// }else if ( num == 4){
...
// let user = prompt('Enter your command (New, Delete, Update, Complete)').toLowerCase();
// if ( user == 'new'){
//     let newTask = prompt('Enter new task');
//     learningTasks.push({task: newTask, complete : false});
//     for ( let i = 0; i < learningTasks.length; i++){
//         let n = i+1;
//    console.log( n + "." + learningTasks[i].task);
//    console.log('complete :' + "" + learningTasks[i].complete);
...
// if ( user == 'update'){
//     let vitri = prompt('Enter position');
//     let newTitle = prompt('Enter new title');
//     learningTasks[Number(vitri) - 1].task = newTitle;
//     for ( let i = 0; i < learningTasks.length; i++){
//         let n = i+1;
//    console.log( n + "." + learningTasks[i].task);
//    console.log('complete :' + "" + learningTasks[i].complete);
...
// if ( user == 'complete'){
//     let vitri = prompt('Enter position');
//     learningTasks[Number(vitri) - 1].complete = true;
//     for ( let i = 0; i < learningTasks.length; i++){
//         let n = i+1;
//    console.log( n + "." + learningTasks[i].task);
//    console.log('complete :' + "" + learningTasks[i].complete);
...
// if ( user == 'delete'){
//     let dele = prompt(' Enter the index of task to delete');
//     learningTasks.splice(dele -1 , 1);
//     for ( let i = 0; i < learningTasks.length; i++){
//         let n = i+1;
//    console.log( n + "." + learningTasks[i].task);
//    console.log('complete :' + "" + learningTasks[i].complete);
